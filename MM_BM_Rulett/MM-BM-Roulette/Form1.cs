...
namespace MM_BM_Roulette
{
    public partial class Form1 : Form
    {
        ...
        private decimal randomBalance;

        public Form1(string playerName, decimal playerBalance, List<string> players, decimal RandomBalance)
        {
            InitializeComponent();
        ...
        private void BtnSpin_Click(object sender, EventArgs e)
        {
            ...
            axWindowsMediaPlayer1.settings.setMode("autoStart", true);
            ...
            /*if (Gyszam == random.Next(0, 37))
            {
                Players[0] += randomBalance;
                Players[1] += randomBalance;
                Players[2] += randomBalance;
                Players[3] += randomBalance;
                Players[4] += randomBalance;
            }
            ...
            else if ((tet == "Első 2:1" && (Gyszam % 3 == 0)) ||
                     (tet == "Második 2:1" && (Gyszam % 3 == 2)) ||
                     (tet == "Harmadik 2:1" && (Gyszam % 3 == 1)))
            {
